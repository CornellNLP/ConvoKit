...
+================================+============+===========+============+============+============+===========+===========================+
| (Decoder-based) Gemma2 9B      | $71.0$     | $69.1$    | $76.1$     | $72.3$     | $34.2$    | $3.9$      | $+1.8 (8.4 - 6.6)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Decoder-based) Mistral 7B     | $70.7$     | $68.8$    | $76.0$     | $72.1$     | $34.6$    | $4.0$      | $+2.9 (8.1 - 5.2)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Decoder-based) Phi4 14B       | $70.5$     | $67.7$    | $78.4$     | $72.6$     | $37.5$    | $4.0$      | $+2.0 (7.7 - 5.7)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Decoder-based) LlaMa3.1 8B    | $70.0$     | $68.8$    | $73.2$     | $70.9$     | $33.2$    | $4.0$      | $+1.7 (7.3 - 5.6)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Encoder-based) DeBERTaV3-large| $68.9$     | $67.3$    | $73.7$     | $70.3$     | $36.0$    | $4.2$      | $+1.1 (7.6 - 6.5)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Encoder-based) RoBERTa-large  | $68.6$     | $67.1$    | $73.4$     | $70.0$     | $36.1$    | $4.2$      | $+1.6 (7.5 - 5.9)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Encoder-based) RoBERTa-base   | $68.1$     | $67.3$    | $70.6$     | $68.8$     | $34.4$    | $4.2$      | $+0.7 (7.4 - 6.7)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Encoder-based) DeBERTaV3-base | $67.9$     | $66.7$    | $71.4$     | $69.0$     | $35.7$    | $4.2$      | $+1.5 (7.2 - 5.7)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Encoder-based) SpanBERT-large | $67.0$     | $65.8$    | $70.5$     | $68.1$     | $36.6$    | $4.2$      | $+1.3 (8.3 - 7.0)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Encoder-based) SpanBERT-base  | $66.4$     | $64.7$    | $72.0$     | $68.2$     | $39.3$    | $4.4$      | $+1.7 (9.6 - 8.0)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Encoder-based) BERT-large     | $65.7$     | $66.0$    | $65.4$     | $65.5$     | $34.1$    | $4.2$      | $+0.4 (7.8 - 7.3)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
| (Encoder-based) BERT-base      | $65.3$     | $64.1$    | $70.1$     | $66.9$     | $39.5$    | $4.4$      | $+1.9 (9.7 - 7.8)$        |
+--------------------------------+------------+-----------+------------+------------+-----------+------------+---------------------------+
