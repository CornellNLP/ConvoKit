...
def setup_test_environment():
    ...
    test_subdirs = [
        'general', 'general.binary_data', 'general.fill_missing_convo_ids',
        'general.from_pandas', 'general.load_and_dump_corpora', 'general.merge_corpus',
        'general.metadata_operations', 'general.traverse_convo',
        'bag_of_words', 'phrasing_motifs', 'politeness_strategies', 'text_processing'
    ]
...
def discover_tests_safely():
    ...
    tests = loader.discover(
        start_dir=tests_dir,
        pattern="test_*.py",
        top_level_dir=os.path.dirname(tests_dir)
    )
